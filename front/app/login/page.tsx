            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg w-full max-w-sm">
                ...
                <div className="mb-4">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 border rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"                        required
                    />
                </div>
